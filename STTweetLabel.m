...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.colorHashtag = [UIColor colorWithWhite:170.0/255.0 alpha:1.0];
        self.colorLink = [UIColor colorWithRed:100.0/255.0 green:100.0/255.0 blue:253.0/255.0 alpha:1.0];
    }
    return self;
}
